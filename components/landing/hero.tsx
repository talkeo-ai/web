      ...
      <div className="flex min-h-0 flex-1 flex-col px-6 lg:flex-row lg:items-center lg:px-8">
        <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col lg:grid lg:flex-initial lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          <div className="mx-auto max-w-lg text-center">
            {/* Loose leading on purpose, and it is the whole effect: a rounded
                display packed tight reads as a logo, while the same face given
                air reads as a sentence someone is saying to you.

                500 and not the bold this face was drawn around: light text on
                a dark surface blooms, so the stroke gains weight the reference
                never had. Matching it means correcting downward.
            ...
            <h1 className="text-foreground font-heading text-[28px] leading-[1.4] font-medium [font-stretch:96%] sm:text-[32px] lg:text-[44px]">
              {t("headline")}
            </h1>
            ...
            {/* Both actions share one width rather than sizing to their own
                ...
                `mt-8` and a tight gap — the pair belongs to the headline, and
                to each other more than to it. */}
            <div className="mx-auto mt-8 flex w-full max-w-[330px] flex-col gap-3">
          ...
          {/* Orb — centered in remaining space on mobile, right on desktop */}
