...
export const ONBOARDING_SCREENS = {
  // The whole interview is one screen. The name and how they want to answer
  // used to be a screen each; they are turns now, asked by the assistant like
  // everything after them, and answered in the panel beside the conversation.
  chat: { step: "talkeo_interview", order: 0 },
